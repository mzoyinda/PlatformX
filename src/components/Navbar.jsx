...
<div className="box-border md:px-16 flex justify-between items-center">
    ...
    <Link href="https://bit.ly/platformX-masterclass" target="_blank" rel="noopener noreferrer" className="px-4 sm:px-8 py-3 text-sm md:text-base sm:py-4 bg-transparent border-[1px] border-solid border-[#fa3f01] hover:bg-[#fa3f01] text-white rounded-lg">
    Register Now
</Link>
