...
const Header = () => {
  return (
    <header className='overflow-hidden px-4 pt-8 lg:pt-16'>
        <Navbar/>
        <div className={` h-[600px] w-full aspect-[4/3] px-4 md:px-0 flex flex-col text-center items-center justify-center  bg-[url("../../public/banner.png")] bg-cover bg-no-repeat bg-center`}>
        ...
        <p className='opacity-75 leading-[25px] text-sm py-8'>Join youths, thought leaders, tech enthusiasts and industry experts as we engage in thoughtful conversations on pressing societal
issues, rooted in values and aiming for meaningful impact</p>
